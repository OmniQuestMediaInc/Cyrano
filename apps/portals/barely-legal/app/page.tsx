...
// I — Portal landing page: Barely Legal — SEO metadata + Hero section.
import type { Metadata } from 'next';
import { getTheme, getPortalDescription, getPortalKeywords } from '@cyrano/shared-ui';

const PORTAL = 'BARELY_LEGAL';
const PORTAL_SLUG = 'barely-legal';
...
export default function BarelyLegalPage() {
  const theme = getTheme(PORTAL);
  return (
    <main

...
// I — Portal landing page: Lotus Bloom — SEO metadata + Hero section.
import type { Metadata } from 'next';
import { getTheme, getPortalDescription, getPortalKeywords } from '@cyrano/shared-ui';

const PORTAL = 'LOTUS_BLOOM';
const PORTAL_SLUG = 'lotus-bloom';
...
export default function LotusBloomPage() {
  const theme = getTheme(PORTAL);
  return (
    <main

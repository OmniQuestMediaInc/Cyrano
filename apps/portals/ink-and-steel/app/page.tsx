...
// I — Portal landing page: Ink & Steel — SEO metadata + Hero section.
import type { Metadata } from 'next';
import { getTheme, getPortalDescription, getPortalKeywords } from '@cyrano/shared-ui';

const PORTAL = 'INK_AND_STEEL';
const PORTAL_SLUG = 'ink-and-steel';
...
export default function InkAndSteelPage() {
  const theme = getTheme(PORTAL);
  return (
    <main

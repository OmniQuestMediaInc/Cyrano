...
// I — Portal landing page: Dark Desires — SEO metadata + Hero section.
import type { Metadata } from 'next';
import { getTheme, getPortalDescription, getPortalKeywords } from '@cyrano/shared-ui';

const PORTAL = 'DARK_DESIRES';
const PORTAL_SLUG = 'dark-desires';
...
export default function DarkDesiresPage() {
  const theme = getTheme(PORTAL);
  return (
    <main
